...
```
To get a clone of the project, run `git clone https://github.com/white3d/Rails-Chat-App.git`
```
...
Feel free to check the [issues page](https://github.com/white3d/Rails-Chat-App/issues)
